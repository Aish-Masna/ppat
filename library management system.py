...
rbf_bg = 'lightgray'  # Right Bottom Frame Background Color
btn_hlb_bg = 'white'  # Background color for Head Labels and Buttons
...
root = Tk()
root.title('LMS-Library Management System')
...
# Left Frame
Label(left_frame, text='Book Name', bg=btn_hlb_bg, font=lbl_font).place(x=98, y=25)
Entry(left_frame, width=25, font=entry_font, text=bk_name).place(x=45, y=55)

Label(left_frame, text='Book ID', bg=btn_hlb_bg, font=lbl_font).place(x=110, y=105)
bk_id_entry = Entry(left_frame, width=25, font=entry_font, text=bk_id)
bk_id_entry.place(x=45, y=135)

Label(left_frame, text='Author Name', bg=btn_hlb_bg, font=lbl_font).place(x=90, y=185)
Entry(left_frame, width=25, font=entry_font, text=author_name).place(x=45, y=215)

Label(left_frame, text='Status of the Book', bg=btn_hlb_bg, font=lbl_font).place(x=75, y=265)
